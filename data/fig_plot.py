...
labels_ap = [r'$P_{max}$: 0.79, without absorber', r'$P_{max}$: 0.86, without absorber', r'$P_{max}$: 0.93, without absorber',
             r'$P_{max}$: 0.79, with absorber', r'$P_{max}$: 0.86, with absorber', r'$P_{max}$: 0.93, with absorber']

labels_eg = [r'$\epsilon$: 0.05, without absorber', r'$\epsilon$: 0.10, without absorber', r'$\epsilon$: 0.15, without absorber',
             r'$\epsilon$: 0.05, with absorber', r'$\epsilon$: 0.10, with absorber', r'$\epsilon$: 0.15, with absorber']
...
if alg == 'aio':
    ...
    plt.plot(ap_snr, ap_pr, 'g', linewidth=2, label = '{}-greedy: without absorber'.format(r'$\epsilon$'))
    plt.plot(ap_snr_abs, ap_pr_abs, c = 'black', linewidth=2, linestyle = (0,(5,1)), label = '{}-greedy: with absorber'.format(r'$\epsilon$'))
